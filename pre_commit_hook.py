...
def run_quick_checks():
    ...
    checks = [
        # Python syntax check
        ("python -m py_compile simple_mcp_server.py enhanced_mcp_server.py security_privacy_server.py ai_integration_server.py", "Python syntax validation"),
        ...
        ("flake8 --select=E9,F63,F7,F82 simple_mcp_server.py enhanced_mcp_server.py security_privacy_server.py ai_integration_server.py", "Critical syntax errors"),
        
        # Basic security check
        ("bandit -ll simple_mcp_server.py enhanced_mcp_server.py security_privacy_server.py ai_integration_server.py", "High-severity security issues"),
    ]
